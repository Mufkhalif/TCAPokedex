...
public enum AppUtil {
    public static var version = Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as? String ?? "null"

    public static var build = Bundle.main.object(forInfoDictionaryKey: "CFBundleVersion") as? String ?? "null"
