...
extension DetailPokemonResponse: Equatable {
  public static func == (lhs: DetailPokemonResponse, rhs: DetailPokemonResponse) -> Bool {
...
struct Stat: Codable, Equatable, Identifiable {
  let id = UUID()
